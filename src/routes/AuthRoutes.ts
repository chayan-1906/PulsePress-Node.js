...
router.get('/verify-magic-link', authRateLimiter, verifyMagicLinkController);               // /api/v1/auth/verify-magic-link
router.post('/check-auth-status', authRateLimiter, checkAuthStatusController);               // /api/v1/auth/check-auth-status
